...
/**
 * EMI-backed slot renderer: item icons drawn through [EmiStack.render] (EMI styled), and left /
 * right click opening EMI recipes / uses. Tooltip drawing goes through vanilla
 * [GuiGraphics.renderTooltip] so style mods can hook it.
 *
