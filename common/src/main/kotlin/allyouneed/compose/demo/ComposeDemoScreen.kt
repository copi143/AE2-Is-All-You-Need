...
import allyouneed.compose.material.Button
import allyouneed.compose.material.Slider
import allyouneed.compose.material.Spacer
import allyouneed.compose.material.Text
import allyouneed.compose.platform.ComposeScreen
import allyouneed.compose.ui.layout.Column
import allyouneed.compose.ui.layout.Row
...
class ComposeDemoScreen : ComposeScreen(Component.literal("Compose Demo")) {
    ...
    private fun Box(color: Int, size: Int) {
        allyouneed.compose.ui.layout.Box(
            modifier = Modifier
                .size(size)
